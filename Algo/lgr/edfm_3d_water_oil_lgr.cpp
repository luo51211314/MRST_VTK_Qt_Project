...
int main() {
    ...
    sim.run(100.0); // SAFE default: 10 days

    std::cout << "Done. Outputs: output_sim_lgr.csv, final_field_lgr.csv, segments_lgr.csv, grid_info_lgr.csv, well_info_lgr.csv, fracture_geometry_lgr.csv" << std::endl;
    return 0;
}